...
public abstract class YouTubeExtractorAndroid /*extends AsyncTask<String, Void, HashMap<Integer, YtFile>>*/ {
    ...
    //mkdir ./fakeCache
    private final String cacheDirPath = "C:\\Users\\bened\\eclipse-workspace\\javaExtractor\\fakeCache";
   ...
   public YouTubeExtractorAndroid() {
    ...
    private HashMap<Integer, YtFile> getStreamUrls() throws IOException, InterruptedException, JSONException {
